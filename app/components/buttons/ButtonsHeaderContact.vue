...
<template>
  <UButton
    :to="contactLink"
    variant="outline"
    class="relative inline-flex items-center gap-3 rounded-2xl px-4 py-3 text-[22px] text-primary hover:text-[#ffffff] shadow-[0_0_48px_rgba(14,52,180,0.55)] ring-1 ring-primary/60"
    :ui="{ base: 'inline-flex font-light items-center gap-3 hover:bg-primary group/btn' }"
  >
